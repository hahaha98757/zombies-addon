...
class CommandInternalTimer: CustomCommandBase() {
    ...
    override fun getCommandUsage(sender: ICommandSender?) = "/internaltimer <run|stop>"
    ...
    override fun addTabCompletionOptions(sender: ICommandSender?, args: Array<String?>, pos: BlockPos?): List<String>? {
        return if (args.isNotEmpty()) getListOfStringsMatchingLastWord(args, "run", "stop") else null
    }
}